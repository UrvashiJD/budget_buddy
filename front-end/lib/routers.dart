import 'package:fin_track/models/creditor.dart';
import 'package:fin_track/models/debtor.dart';
import 'package:fin_track/models/goal.dart';
import 'package:fin_track/models/group.dart';
import 'package:fin_track/models/transaction.dart';
import 'package:fin_track/screens/creditors/add_creditor_screen.dart';
import 'package:fin_track/screens/debtors/add_debtor_screen.dart';
import 'package:fin_track/screens/goals/add_goal_screen.dart';
import 'package:fin_track/screens/categories_screen.dart';
import 'package:fin_track/screens/groups/add_expense_screen.dart';
import 'package:fin_track/screens/groups/groupExpense_detail_screen.dart';
import 'package:fin_track/screens/groups/group_detail_screen.dart';
import 'package:fin_track/screens/login/otp_screen.dart';
import 'package:fin_track/screens/login/splash_screen.dart';
import 'package:fin_track/screens/profile/create_profile_screen.dart';
import 'package:fin_track/screens/creditors/creditors_screen.dart';
import 'package:fin_track/screens/debtors/debtors_screen.dart';
import 'package:fin_track/screens/goals/edit_goal_screen.dart';
import 'package:fin_track/screens/profile/edit_profile_screen.dart';
import 'package:fin_track/screens/creditors/edit_update_creditor_screen.dart';
import 'package:fin_track/screens/goals/goal_detail_screen.dart';
import 'package:fin_track/screens/goals/goals_screen.dart';
import 'package:fin_track/screens/goals/reached_goal_detail_screen.dart';
import 'package:fin_track/screens/groups/create_group_screen.dart';
import 'package:fin_track/screens/groups/groups_screen.dart';
import 'package:fin_track/screens/home_screen.dart';
import 'package:fin_track/screens/login/mobile_number_screen.dart';
import 'package:fin_track/screens/transactions/new_transaction_screen.dart';
import 'package:fin_track/screens/profile/profile_screen.dart';
import 'package:fin_track/screens/settings_screen.dart';
import 'package:fin_track/screens/transactions/transaction_detail_screen.dart';
import 'package:fin_track/screens/debtors/update_delete_debtor_screen.dart';
import 'package:fin_track/screens/transactions/update_transaction_screen.dart';
import 'package:fin_track/services/chart_service.dart';
import 'package:fin_track/services/transaction_filtering_service.dart';
  ...
  switch (routeSettings.name) {
    ...
    case GroupExpenseDetailScreen.routeName:
      ...
      return PageTransition(
        child: GroupExpenseDetailScreen(
            ge: da.ge, members: da.members, amount: da.amount),
        type: PageTransitionType.fade,
        duration: const Duration(microseconds: 100),
      );
    ...
    default:
      return MaterialPageRoute(
        builder: (_) => Scaffold(
          appBar: AppBar(
            title: const Text("Oops..404 Not found"),
          ),
          body:
              Center(child: Text('No route defined for ${routeSettings.name}')),
        ),
      );
  }
}
