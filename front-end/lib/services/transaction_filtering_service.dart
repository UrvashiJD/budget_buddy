...
class TransactionFilteringScreen extends StatefulWidget {
  ...
  const TransactionFilteringScreen({Key? key, required this.transactions})
      : super(key: key);
...
class _TransactionFilteringScreenState
    ...
    if (enteredKeyword.trim().isEmpty) {
      ...
      results = widget.transactions
          .where((t) =>
              ...
              t.amount.toString().contains(enteredKeyword.toLowerCase()) ||
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: foundTransactions.isEmpty
          ? const Center(
              child: Text(
                "No results found !",
              ...
              builder: (context, setState) => AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                        onPressed: () async {
                          Navigator.of(context).pop();
                          _profileController.exportTransactions(
                              startDate, endDate);
                        },
                        child: Text(
                          "OK",
