...
class MyChartData{
  ...
  MyChartData({required this.month,required this.year,required this.category,required this.totalAmount});
}
...
class MyChartScreen extends StatefulWidget {
  ...
  const MyChartScreen(
      {Key? key, required this.chartData}) : super(key: key);
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Container(
                              ...
                              child: PieChart(
                                dataMap:
                                    _profileController.getMapDataOfGivenCategory(
                                        widget.chartData.month , widget.chartData.year,widget.chartData.category),
                                  ...
                                  child: CupertinoScrollbar(
                                    child: ListView(
                                      ...
                                      children: List.generate(
                                        _profileController.getTransactionsByGivenCategory(widget.chartData.category).length,
                                        (i) {
