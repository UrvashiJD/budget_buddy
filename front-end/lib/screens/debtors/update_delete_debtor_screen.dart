...
class UpdateDeleteDebtorScreen extends StatefulWidget {
  ...
  const UpdateDeleteDebtorScreen({Key? key, required this.debtor})
      : super(key: key);
...
class _UpdateDeleteDebtorScreenState extends State<UpdateDeleteDebtorScreen> {
  ...
  void initState() {
    ...
    finalDate =
        DateTime(widget.debtor.year, widget.debtor.month, widget.debtor.day);
          ...
          if (formKey.currentState!.validate()) {
            if (_debtorMobileController.text.length == 10) {
              ...
              await _debtorsController.editDebtor(
                  updatedDebtor, widget.debtor.id);
              stopLoader();
                          ...
                          Expanded(
                            child: Align(
                              ...
                              child: IconButton(
                                onPressed: () async {
                                  showLoader(context);
                                  await _debtorsController
                                      .deleteDebtor(widget.debtor.id);
                                  stopLoader();
                                  Navigator.of(context).pop();
                                },
                                icon: const Icon(
