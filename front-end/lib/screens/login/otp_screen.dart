                ...
                child: ElevatedButton(
                  onPressed: () async {
                    if (_fieldOne.text.isEmpty ||
                      ...
                      showErrFlushBar(context, "Invalid OTP", "Enter 6 digit OTP");
                    } else {

                      String finalOTP = _fieldOne.text +
                          _fieldTwo.text +
                          _fieldThree.text +
                          _fieldFour.text +
                          _fieldFive.text +
                      ...
                      var res = await _loginController.verifyOTP(finalOTP);
                      ...
                      if (res.statusCode == 400) {
                        ...
                        if(body["isRegisterdUser"]==true){
                          ...
                          Navigator.of(context).pushNamedAndRemoveUntil(CreateProfileScreen.routeName, (route) => false);
                        }
                      }
                    }
                  },
