...
class CreditorsScreen extends StatefulWidget {
  ...
  const CreditorsScreen({Key? key}) : super(key: key);
...
class _CreditorsScreenState extends State<CreditorsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => _creditorsController.loading.value
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.of(context).pushNamed(UpdateDeleteCreditorScreen.routeName,arguments: _creditorsController.creditors[index]);
                              },
                              child: Container(
                                height: 135.0,
