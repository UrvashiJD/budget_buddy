...
class DetailScreenArgument {
  ...
  DetailScreenArgument(
      {required this.ge, required this.members, required this.amount});
}
        ...
        children: [
          Container(
            ...
            padding: const EdgeInsets.only(
                left: 16.0, top: 16.0, right: 16.0, bottom: 100),
                        ...
                        : RawScrollbar(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  padding: settlementMsg == "You'll pay for"
                                      ? EdgeInsets.only(
