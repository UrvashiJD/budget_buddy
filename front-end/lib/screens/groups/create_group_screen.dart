...
import 'package:fin_track/components/custom_textform_field.dart';
...
class _CreateGroupScreenState extends State<CreateGroupScreen> {
  ...
  void _runFilter(String enteredKeyword) {
    ...
    if (enteredKeyword.trim().isEmpty) {
      ...
      results = widget.contacts!.where((t) {
        if (t.userName.toLowerCase().contains(enteredKeyword.toLowerCase()) ||
            t.userMobile.toLowerCase().contains(enteredKeyword.toLowerCase())) {
          return true;
        }
        return false;
      }).toList();
                      ...
                      child: Column(
                        children: [
                          DropdownButtonFormField(
                            ...
                            items: const [
                              DropdownMenuItem(
                                  child: Text("FlatMates"), value: "FlatMates"),
                              DropdownMenuItem(
                                  child: Text("Office"), value: "Office"),
                              DropdownMenuItem(
                                  child: Text("Trip"), value: "Trip"),
                              DropdownMenuItem(
                                  child: Text("Friends"), value: "Friends"),
                              DropdownMenuItem(
                  ...
                  onPressed: () async  {
                    ...
                    if (groupNameController.text.isEmpty) {
                      return showErrFlushBar(
                          context, "Error ", "Group name can not be null");
                    } else if (addedPeople.isEmpty) {
                      return showErrFlushBar(
                          context, "Error ", "Please add people to group");
                    }
                    String members = "";
                      ...
                      children: <Widget>[
                        ...
                        Center(
                          child: OutlinedButton(
                            style:
                                OutlinedButton.styleFrom(foregroundColor: kBackColor),
                            onPressed: () {
                              Navigator.of(context).pop();
                              callback();
                            },
