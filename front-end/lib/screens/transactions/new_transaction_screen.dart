...
class _NewTransactionScreenState extends State<NewTransactionScreen> {
  ...
  void allOk() async {
    ...
    // _categoryController.expenses[i].img.contains("custom") ? "assets/images/custom/${_categoryController.expenses[i].img}" : "assets/images/expenses/${_categoryController.expenses[i].img}",
