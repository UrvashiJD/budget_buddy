...
class UpdateTransactionScreen extends StatefulWidget {
  ...
  final Transaction t;
  const UpdateTransactionScreen({Key? key, required this.t}) : super(key: key);
  @override
...
class _UpdateTransactionScreenState extends State<UpdateTransactionScreen> {
                                      ...
                                      itemBuilder: (context, i) {
                                        return GestureDetector(
                                          ...
                                          child: Container(
                                            width: 90.0,
                                            decoration: BoxDecoration(
                                              color: imgIndexForPaymentMode == i
                                                  ? kBackColor.withOpacity(0.1)
                                                  : Colors.transparent,
                                            ),
                                            child: Column(
  ...
  void allOk() async {
    ...
    transaction["t_name"] = selectedValue == 0
