...
class TransactionDetailScreen extends StatefulWidget {
  ...
  const TransactionDetailScreen(
      {Key? key, required this.t, required this.isFromFilterScreen})
      : super(key: key);
  @override
...
class _TransactionDetailScreenState extends State<TransactionDetailScreen> {
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                ...
                                child: AutoSizeText(
                                  ...
                                  style: TextStyle(
                                    color: widget.t.category == "Income"
                                        ? kSuccessColor
                                        : kErrorColor,
                                    fontSize: 15.0,
                                    fontWeight: FontWeight.w500,
  ...
  Widget myDetailRow(
      {required String title, required String value, required double height}) {
    return SizedBox(
      height: height,
      child: Row(
        children: [
