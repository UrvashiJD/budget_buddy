...
class ReachedGoalScreen extends StatelessWidget {
  ReachedGoalScreen({Key? key}) : super(key: key);
                        ...
                        children: [
                          Padding(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                Navigator.of(context).pushNamed(ReachedGoalDetailScreen.routeName,arguments: _goalsController.reachedGoals[i]);
                              },
                            ),
                          ),
                          const Padding(
