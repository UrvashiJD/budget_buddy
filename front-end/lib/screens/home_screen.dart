...
import 'package:fin_track/components/no_transactions_msg.dart';
import 'package:fin_track/controllers/category_controller.dart';
import 'package:fin_track/controllers/creditors_controller.dart';
import 'package:fin_track/controllers/debtors_controller.dart';
import 'package:fin_track/controllers/goals_controller.dart';
import 'package:fin_track/controllers/group_controller.dart';
import 'package:fin_track/controllers/login_controller.dart';
import 'package:fin_track/controllers/profile_controller.dart';
...
import 'package:fin_track/components/custom_drawer.dart' as my_drawer;
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              icon:
                              areTransactionsBeingFetched ? showCustomLoader(Colors.black) : const Icon(Icons.search, color: Colors.black),
                            ),
                          ],
                        ...
                        Expanded(
                          child:
                              Obx(() => _profileController.loading.value == true
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              CustomBalanceCard(
                                                income: _profileController.income.value,
                                                expense: _profileController.expense.value,
                                                balance: _profileController.balance.value,
                                                month: _profileController.selectedDate.value.month,
                                                year:  _profileController.selectedDate.value.year,
                                              ),
                                              Expanded(
                                                child: Padding(
                                                  padding:
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return Theme(
                                                                ...
                                                                child:
                                                                  ...
                                                                  initiallyExpanded:
                                                                      true,
                                                                  childrenPadding: const EdgeInsets
                                                                          .symmetric(
                                                                      horizontal:
                                                                          15.0,
                                                                      vertical:
                                                                        ...
                                                                        children: [
                                                                          Card(
                                                                            ...
                                                                            ListTile(
                                                                              onTap:
                                                                                  () {
                                                                                Navigator.of(context).pushNamed(TransactionDetailScreen.routeName, arguments: [
                                                                                  finalList[i],
                                                                                  false
                                                                                ]);
                                                                              },
                                                                              onLongPress:
                                                                                  () {
                                                                                showOperationBottomSheet(finalList[i]);
                                                                              },
                                                                              dense:
                                                                              true,
                                                                              title:
                                                                              ...
                                                                              subtitle: finalList[i].description == finalList[i].name
                                                                                  ? const Text("")
                                                                                  : Padding(
                                                                              ...
                                                                              trailing:
                                                                              Text(
                                                                                finalList[i].category == "Income" ? "${finalList[i].amount}" : "- ${finalList[i].amount}",
                                                                                style: TextStyle(
                                                                                  color: finalList[i].category == "Income" ? Colors.green : Colors.red,
                                                                                  fontSize: 16.0,
                                                                                  fontWeight: FontWeight.w600,
                                                                                ),
                                                                              ),
                  ...
                  if (res.statusCode != 200) {
                    ...
                    if (success) {
                      ...
                      Navigator.of(context).pushNamedAndRemoveUntil(
                          MobileNumberScreen.routeName, (route) => false);
                      showSuccessFlushBar(
