...
class GoalsController extends GetxController {
  List<Goal> goals = List<Goal>.empty().obs;
  List<Goal> reachedGoals = List<Goal>.empty().obs;
  List<GoalCategory> goalCategories = List<GoalCategory>.empty().obs;
  ...
  String getCategoryImagePath (String catID){
    GoalCategory gc = goalCategories.firstWhere((element) => element.id==catID);
    return gc.imgSrc;
  }
